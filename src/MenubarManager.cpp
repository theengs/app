...
{
    QDesktopServices::openUrl(QUrl("https://github.com/theengs/app"));
}

void MenubarManager::issuetracker()
{
    QDesktopServices::openUrl(QUrl("https://github.com/theengs/app/issues"));
}

void MenubarManager::releasenotes()
{
    QDesktopServices::openUrl(QUrl("https://github.com/theengs/app/releases"));
}
